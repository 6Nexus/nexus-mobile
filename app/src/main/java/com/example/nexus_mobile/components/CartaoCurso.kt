...
fun CartaoCurso(
    ...
    onFavoritoChanged: (Int, Boolean) -> Unit // Função passada como parâmetro
) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
        ...
        Column {
            ...
            Column(modifier = Modifier.padding(18.dp)) {
                Row(
                    ...
                    // Usando o componente Favorito
                    Favorito(
                        cursoId = curso.id,
                        favoritos = favoritos,
                        onFavoritoChanged = onFavoritoChanged // Passando a função aqui
                    )
                }
